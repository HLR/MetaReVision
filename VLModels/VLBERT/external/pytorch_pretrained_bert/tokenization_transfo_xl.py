...
class LMOrderedIterator(object):
    def __init__(self, data, bsz, bptt, device='cpu', ext_len=None):
        """
            rawdata -- LongTensor -- the LongTensor is strictly ordered
        """
        self.bsz = bsz
        self.bptt = bptt
        ...
        # Evenly divide the rawdata across the bsz batches.
...
class LMShuffledIterator(object):
    def __init__(self, data, bsz, bptt, device='cpu', ext_len=None, shuffle=False):
        """
            rawdata -- list[LongTensor] -- there is no order among the LongTensors
        """
        self.data = data
    ...
    def stream_iterator(self, sent_stream):
        # streams for each rawdata in the batch
