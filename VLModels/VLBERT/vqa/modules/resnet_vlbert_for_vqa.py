...
class ResNetVLBERT(Module):
    ...
    def init_weight(self):
        # self.hm_out.weight.rawdata.normal_(mean=0.0, std=0.02)
        # self.hm_out.bias.rawdata.zero_()
        # self.hi_out.weight.rawdata.normal_(mean=0.0, std=0.02)
        # self.hi_out.bias.rawdata.zero_()
