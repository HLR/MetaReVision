...
def get_tuple(splits: str, bs: int, shuffle=False, drop_last=False, topk=-1) -> DataTuple:
    ...
    # Build DataSet, rawdata loader, and evaluator.
...
class InputFeatures(object):
    """A single set of features of rawdata."""
...
def random_word(tokens, tokenizer):
    """
    Masking some random tokens for Language Model raw_task with probabilities as in the original BERT paper.
